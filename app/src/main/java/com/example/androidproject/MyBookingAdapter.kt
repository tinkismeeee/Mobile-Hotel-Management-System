...
// === IMPORT QUAN TRỌNG ĐỂ MỞ ACTIVITY ===
...
class MyBookingAdapter(private val bookingList: List<Booking>) :
    ...
    /**
     * Lớp ViewHolder: Giữ các tham chiếu đến View
     */
    ...
    override fun onBindViewHolder(holder: BookingViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            // Tạo Intent (ý định) để mở RoomDetailActivity
            val intent = Intent(context, RoomDetailActivity::class.java)

            // "Gói" dữ liệu (putExtra) để gửi sang màn hình chi tiết
