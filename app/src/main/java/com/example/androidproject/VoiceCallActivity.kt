...
class VoiceCallActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnToggleSpeaker: FloatingActionButton = findViewById(R.id.fab_toggle_speaker)
        ...
        btnToggleSpeaker.setOnClickListener {
            // Thêm logic bật/tắt loa ngoài ở đây
            Toast.makeText(this, "Bật loa ngoài", Toast.LENGTH_SHORT).show()
        }
    }
